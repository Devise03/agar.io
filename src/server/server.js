...
function tickPlayer(currentPlayer) {
    ...
    for(var z=0; z<currentPlayer.cells.length; z++) {
        ...
        if (currentPlayer.massTotal > currentPlayer.score) {
            currentPlayer.score = currentPlayer.massTotal;
            sockets[currentPlayer.id].emit('playerScore', {score: currentPlayer.score});
        }
